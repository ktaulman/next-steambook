...
export default function TrendingNewFooter() {
    ...
    return (
        <div>
            <form action={formAction} className='flex gap-1 justify-start items-center'>
                <motion.button
                    ...
                    disabled={pending} >
                    <ArrowPathIcon color="#FFFFFF" className='h-8 w-8 hover:text-2xl hover:cursor-pointer' />
                </motion.button>
